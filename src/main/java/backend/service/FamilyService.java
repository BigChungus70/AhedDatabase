...
public class FamilyService {
    ...
    public List<Family> searchFamilies(
        ...
        families.forEach(f -> f.setContainingLists(map.getOrDefault(f.getId(), List.of())));
    ...
    public Family updateFamily(Family family) {
        ...
        if (family.getChildren() != null && !family.getChildren().equals(existing.getChildren())) {
    ...
    public Family saveFamily(Family family) {
        ...
        Integer maxSeq = familyRepo.findMaxSequence(); // e.g. SELECT MAX(CAST(SUBSTRING(code, 4) AS int)) FROM Family
